...
public class OrderStatusController {
    ...
    @PostMapping
    public ResponseEntity<?> create(@Valid @RequestBody OrderStatus request) {
        var ose = service.findByName(request.getName());
        if (ose) {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<?> update(@PathVariable Long id, @Valid @RequestBody OrderStatus request) {
